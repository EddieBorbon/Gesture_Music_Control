...
void setup() {
  ...
  oscP5 = new OscP5(this,7000); //listen for OSC messages on port 12000 (Wekinator default)
  dest = new NetAddress("127.0.0.1",6500); //send messages back to Wekinator on port 6448, localhost (this machine) (default)
...
void draw() {
  ...
  text( "Listening for /wek/outputs on port 9000", 5, 30 );
